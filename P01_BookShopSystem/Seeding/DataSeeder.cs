...
namespace BookShop.Seeding
{
    public static class DataSeeder
    {
        ...
        private static void Initialize()
        {
            ...
            BookCategories = GetBookCategoriesGenerator().Generate(5).Distinct().ToList();
        }
        ...
        private static Faker<Book> GetBookGenerator()
        {
            return new Faker<Book>().RuleFor(b => b.BookId, f => Guid.NewGuid())
                ...
                .RuleFor(b => b.EditionType, f => f.Random.Enum<EditionTypes>().ToString())
                .RuleFor(b => b.AgeRestriction, f => f.Random.Enum<AgeRestrictions>().ToString())
